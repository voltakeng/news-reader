(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var Comments = function Comments() {
      ...
      var commentsForArticleId = ["comments[article.id]"]; // Dispatch loadCommentsForArticleId with useEffect here.
    
      (0, _react.useEffect)(function () {
        if (article !== undefined) {
          dispatch((0, _commentsSlice.loadCommentsForArticleId)(article.id)); //commentsForArticleId = comments[article.id];
        }
      }, [article]);
    ...
    exports["default"] = exports.createCommentIsPending = exports.isLoadingComments = exports.selectComments = exports.commentsSlice = exports.loadCommentsForArticleId = void 0;
    ...
    var loadCommentsForArticleId = (0, _toolkit.createAsyncThunk)('comments/loadCommentsForArticleId', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, thunkAPI) {
        var response, json;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
    ...
    var commentsSlice = (0, _toolkit.createSlice)({
      ...
      extraReducers: (_extraReducers = {}, _defineProperty(_extraReducers, loadCommentsForArticleId.pending, function (state, action) {
        true, _readOnlyError("isLoadingComments");
        failedToLoadComments = false;
      }), _defineProperty(_extraReducers, loadCommentsForArticleId.fulfulled, function (state, action) {
        false, _readOnlyError("isLoadingComments");
        failedToLoadComments = false;
